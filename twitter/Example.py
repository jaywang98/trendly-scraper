...
data = scrape(words=['bitcoin', 'etherium'], since="2015-04-01", until="2015-04-2", from_account=None, interval=1,
              headless=False, display_type="Top", save_images=True, proxy=None, save_dir='outputs_bak',
              resume=False, filter_replies=True, proximity=False, driver=driver, env='.env')
